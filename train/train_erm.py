...
from train.trainer import run_erm
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="ERM training using unified trainer.")
    ...
    parser.add_argument("--output_dir", type=str, default="experiments/erm")
    return parser
